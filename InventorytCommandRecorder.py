...
class InventoryCommandRecorder:
    ...
    def process_transcription(self, filepath):
        # Simulated transcription retrieval - replace with your actual method
        transcription_response = "<Cleaned_Transcription>Place Pikachu in drawer one!</Cleaned_Transcription>"
    ...
    def send_inventory_command(self, transcription):
        ...
        response = requests.post(self.server_url+"/inventory_function", json=data, auth=(self.username, self.password), verify=False)
